...
SITE_IDENTIFIER = www_darkiworld_com/  # identifant (nom de votre fichier) remplacez les espaces et les . par _ AUCUN CARACTERE SPECIAL
SITE_NAME = darki  # nom que KODI affiche
